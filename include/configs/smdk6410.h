 ...
 * Size of malloc() pool
 */
#define CFG_MALLOC_LEN		(CFG_ENV_SIZE + 3*1024*1024)//modify from 1024*1024 to 3*1024*1024 by James
...
//#define CONFIG_BOOTARGS "root=/dev/ram0 rootfstype=cramfs rw ramdisk=32768 initrd=0x50800000,32M init=/linuxrc console=ttySAC2,115200"
//#define CONFIG_BOOTARGS "root=/dev/ram0 rootfstype=cramfs ramdisk=32768 initrd=0x50800000,32M init=/linuxrc console=ttySAC2,115200"
//#define CONFIG_BOOTARGS "root=/dev/mmcblk0p4 rootdelay=2 rw, init=/linuxrc noinitrd console=ttySAC2,115200"
//#define CONFIG_BOOTARGS "root=/dev/mtdblock2 rootfstype=yaffs2 rw ramdisk=32768 initrd=0x50800000,64M init=/linuxrc console=ttySAC1,115200"
//#define CONFIG_BOOTARGS "console=ttySAC1,115200"
...
#define CFG_PROMPT		"PB-free # "	/* Monitor Command Prompt	*/
...
#define DDR_tRFC		110		/* ns (min: 80ns)*/
#define DDR_tRP 		23		/* ns (min: 22.5ns)*/
#define DDR_tRRD		15		/* ns (min: 15ns)*/
#define DDR_tWR 		15		/* ns (min: 15ns)*/
//#define DDR_tXSR		120		/* ns (min: 120ns)*/
#define DDR_tXSR		140		/* ns (min: 120ns)*/
#define DDR_CASL		3		/* CAS Latency 3 */

#else

#define DMC1_MEM_CFG		0x00210012	/* Supports one CKE control, Chip1, Burst4, Row/Column bit */
#define DMC1_MEM_CFG2		0xB41
#define DMC1_CHIP0_CFG		0x150F8
#define DMC1_CHIP1_CFG		0x158F8
#define DMC_DDR_32_CFG		0x0		/* 32bit, DDR */
...
#define CONFIG_BOOTCOMMAND      "onenand read 50008000 600000 300000;onenand read 50800000 900000 100000;bootm 50008000 50800000"
...
#define AUTO_UPDATE
#define SD_STATUS_HANDLE	//for detect the excard
#define SANDISK_INAND
//#undef SANDISK_INAND
#define TEST_EINK
#define EPD_EP3_DVT 
//#define HWCONFIG_EP1
