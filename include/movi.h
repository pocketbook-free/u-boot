...
//#define PART_SIZE_BL		(1 * 1024 * 1024)
#define PART_SIZE_KERNEL	(4 * 1024 * 1024)
//#define PART_SIZE_ROOTFS	(32 * 1024 * 1024)
...
/*ret_mmc_read_failed add by James*/
extern int ret_mmc_read_failed;
#endif
