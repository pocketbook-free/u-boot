...
int ret_mmc_read_failed = 0;
#endif

#ifndef CONFIG_GENERIC_MMC
struct movi_offset_t ofsinfo;
//extern nand_info_t nand_info[]; //removed by James
...
/* 	nand_erase(&nand_info[0], 0x0, CFG_ENV_OFFSET + CFG_ENV_SIZE);
	nand_write(&nand_info[0], 0x0, &total, (u_char *) addr); *///remove by James
